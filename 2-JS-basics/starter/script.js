...
var heightMark = 1.7;
var heightJohn = 1.8;
var bmiM = massMark / (heightMark * heightMark);
var bmiJ = massJohn / (heightJohn * heightJohn);
var isHigher = bmiM > bmiJ;
...
var gameJohn = (89 + 120 + 103) / 3;
var gameMike = (116 + 94 + 123) / 3;
if (gameJohn > gameMike) {
  console.log('Johm win with ' + gameJohn);
} else if (gameJohn === gameMike) {
  console.log('Johm and Mike are equal');
} else {
  console.log('Mike win with ' + gameMike);
}
var gameMary = (97 + 134 + 105) / 3;
if (gameJohn > gameMike && gameJohn > gameMary) {
  ...
  console.log('Mary win with ' + gameMary);
} else {
...
for (var i = 0; i < bills.length; i++) {
  allTips.push(calculateTips(bills[i]));
  finalPaid.push(bills[i] + allTips[i]);
}
...
var isHigher = john.calcBmi() < mark.calcBmi();
if (isHigher) {
  console.log(mark.fullName + ' has BMI ' + mark.bmi);
} else if (john.bmi === mark.bmi) {
  console.log('This is draw!');
} else {
  console.log(john.fullName + ' has BMI ' + mark.bmi);
}

/*
if (isHigher) {
  console.log(mark.fullName + ' has BMI ' + mark.calcBmi());
} else if (john.calcBmi() === mark.calcBmi()) {
  console.log('This is draw!');
} else {
  console.log(john.fullName + ' has BMI ' + mark.calcBmi());
}
*/ 
